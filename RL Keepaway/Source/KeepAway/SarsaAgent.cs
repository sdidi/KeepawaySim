...
namespace Keepaway
{
    public class SarsaAgent : SMDPAgent
    {
 ...
 public SarsaAgent(int numFeatures, int numActions, bool bLearn, double rewards,
                                    double []widths, 
...
public int selectAction()
{
  ...
  // Epsilon-greedy
  if ( bLearning && rand.NextDouble() < epsilon ) {     
         action = rand.Next() % getNumActions();
  }
  else{ 
    action = argmaxQ();
  }
